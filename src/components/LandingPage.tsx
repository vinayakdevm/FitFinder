...
<AnimatePresence>
  <motion.img
    ...
    className="fixed inset-0 w-full h-full object-cover brightness-[1.5] scale-200"
  />
</AnimatePresence>
...
>
          ...
          <p className="text-xl text-white-400 mb-12 max-w-2xl mx-auto leading-relaxed">
...
>
  ...
  <div className="
    ...
    bg-gradient-to-r from-white-400/40 to-white-400/40
  "></div>
