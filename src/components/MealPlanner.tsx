...
<div className="flex items-center gap-3">
  <button 
    ...
    hover:bg-white/20 backdrop-blur-xl transition">
    <ArrowLeft />
  </button>

  <div className="flex items-center gap-3">
    {/* Icon */}
    <div className="p-2 rounded-lg bg-white/10 border border-white/10 backdrop-blur-xl">
    ...
    <div>
      ...
      <p className="text-sm text-gray-300">
        Calorie Target: <span className="font-semibold">{calorieTarget} kcal</span>
          ...
          <div className="flex items-center gap-3">
           <button
  onClick={() => { const s = Date.now(); setSeed(s); buildWeekly(s); }}
  className="px-4 py-2 rounded-xl bg-white/10 border border-white/20 
  backdrop-blur-xl hover:bg-white/20 transition flex items-center gap-2"
>
...
>
  ...
  hover:bg-white/20 backdrop-blur-xl text-sm"
>
  Load
</button>
...
<button
  className="px-3 py-2 bg-white/10 border border-white/20 rounded-lg 
  hover:bg-white/20 backdrop-blur-xl text-sm text-red-300"
>
  Delete
</button>
